                ...
                <tr>
                    <td style="vertical-align:middle;">
                        ...
                        <span style="vertical-align:middle;">
                            名称中包含“<span class="Word"><asp:Literal ID="lit_name" runat="server"></asp:Literal></span>”的词单共有
                            <span class="Red"><asp:Literal ID="lit_num" runat="server" Text="0"></asp:Literal></span>个，以下是详细信息：
                        </span>
                    </td>
