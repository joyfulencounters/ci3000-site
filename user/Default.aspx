...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    ...
    <style type="text/css">
        ...
        .UserFavWordsBox .UserFavWordsHeader {
            position: relative;
            width: 100%;
            height: 32px;
            margin-bottom: 14px;
        ...
        .UserFavWordsBox .UserFavWordsTitle {
            float: left;
            font-size: 18px;
            line-height: 32px;
            color: #427e5f;
        ...
        .UserFavWordsBox .UserFavWordsTitle:before {
            content: "";
            position: absolute;
            left: 0;
            top: 6px;
        ...
        .UserFavWordsBox .UserFavWordsMore {
            position: absolute;
            top: 0;
            right: 0;
            margin: 0;
        ...
        .UserFavWordsBox .UserFavWordsMoreBtn {
        ...
        .UserFavWordsBox .UserFavWordsMoreBtn:hover {
            color: #427e5f;
            border-color: #427e5f;
            text-decoration: none;
        }
...
<div id="MainBox">
	...
	<div class="Boxleft">  	
		...
		<div class="ContentLeftA">
			<div class="ContentLeftTitle1 SimilarWordHeader UserFavWordsHeader">
    <div class="ContentText SimilarWordTitle UserFavWordsTitle">创建的词单</div>
    <div class="ContentMore UserFavWordsMore">
        <asp:HyperLink ID="hypelnk_wlmore" runat="server" Visible="false" CssClass="SimilarMoreBtn UserFavWordsMoreBtn">+更多</asp:HyperLink>
    </div>
</div>
                    ...
                    <ItemTemplate>
                        <div class="CreateWordlistA1" style="clear:both; height:90px;">
                            <div>
                                ...
                                <span class="Gray">创建于<%#Eval("addtime") %></span>
                                <%if (uid == uc.UserID){ %>
                                    <span class="Word">　<a href="/Create_word.aspx?w=<%#Eval("wl_id") %>">编辑</a></span>｜
        ...
        <div class="UserFavWordsBox">
            <div class="ContentLeftTitle1 SimilarWordHeader UserFavWordsHeader" style="clear:both;">
                <div class="ContentText SimilarWordTitle UserFavWordsTitle">收藏的词</div>
                <div class="ContentMore UserFavWordsMore">
                    <asp:HyperLink ID="hypeLnk_more" runat="server" Visible="false" CssClass="SimilarMoreBtn UserFavWordsMoreBtn">+更多</asp:HyperLink>
                </div>
            </div>
            ...
            <div class="TagCloudone">
                <ul>
                    <asp:Repeater ID="rep_coll" runat="server" OnItemCommand="rep_coll_ItemCommand">
                        <ItemTemplate>
                            <li>
                                <span class="BlackWordList">
                                    <a href="/word.aspx?c=<%#Eval("w_id") %>"><%#Eval("name") %></a>
                                </span>
                                <%--<% if (uid == uc.UserID){%>
                                <span>
                                    <asp:LinkButton ID="lnkbtn_delCW"
                                        OnClientClick="return confirm('您确定要删除该词的收藏吗？')"
                                        CommandName="cwDel"
                                        CommandArgument='<%#Eval("w_id") %>'
