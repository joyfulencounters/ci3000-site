...
词单页<%= WebQywy.Data_Public.GetTitleAppend()%>
</asp:Content>
...
<div id="MainBox">
	...
	<div class="Boxleft">
		...
		<div class="PersonalWordlist">
		  ...
		  <div class="PersonalWordlistRight">
			...
			<ul>
		  	...
		  	<div class="WordlistRightB" id="div_sign"><asp:Literal ID="lit_feeling" runat="server">懒家伙，什么感言都没有留下...点击写下心情，快点！</asp:Literal></div>		  
		  </div>
		</div>
          ...
          <div class="CreateWordlistA">
			...
			<div><span class="BlackWord">
                <asp:Literal ID="lit_wname" runat="server"></asp:Literal></span> <span class="Red">
                    <asp:Literal ID="lit_cnum" runat="server"></asp:Literal></span>词 <img src="images/index/index_11.gif" /><span class="Gray">创建于<asp:Literal ID="lit_ctime" runat="server"></asp:Literal></span></div> 
			...
			<div class="CreateWordlistB">
				...
				<div class="CreateWordlistB1"><img src="images/word/word_25.gif" /><span class="Name">评论</span>（<span class="Red"><asp:Literal ID="lit_rnum" runat="server"></asp:Literal></span>） <span class="Gray"><asp:Literal ID="lit_rtime" runat="server"></asp:Literal></span></div>	            
			</div> 
			
			<div class="CreateWordlistC">
				<div id="ShowList"><img src="/images/load.gif" alt="" /></div>
	            <div style="clear:both;" class="page" id="pages"></div>
	            <script language="javascript" type="text/javascript">    
                    CurrentPage(10,10,1);
                </script>
				...
				<asp:Panel ID="pane_addwl" runat="server" Visible="false">
				    <div class="CreateWordlistG">向词单添加词：<input type="text" id="Input_word" name="n" value="输入搜索的词..." maxlength="8" onfocus="if(this.value=='输入搜索的词...')this.value='';" onkeyup="Onkeyup('Input_word');" /></div>
                    <div class="CreateWordlistF"><a href="javascript:void(0);" onclick="WordCheck()"><img src="images/word/word_02.gif" border="0" alt="添加新词" /></a>
                    <div id="sp_Vili" style="color:Red;display:none;">注意：添加的词不能超过8个汉字，中间不可添加空格或其它符号</div></div></asp:Panel>
				</div>				
		  ...
		  <a name="remark"></a>
            ...
            <asp:Repeater ID="rep_RemarkWl" runat="server">
                <ItemTemplate>
					...
					<div class="MessageListTxt"><a href="/user/default.aspx?u=<%#Eval("userid") %>"><span class="Name"><%# Eval("realname")%></span></a> 评论 <span class="Word"><%# Eval("name")%></span>
		...
		<div class="ContentLeft1">
          <div class="ContentLeftTitle1">
              <div class="ContentText"><img src="images/word/word_03.png"  /></div>
				  <div class="zao">
				  	<div id="contentPad">
          ...
          <div class="WordBoxF">
              <div> <textarea id="txt_ContentR" runat="server" name="textarea" cols="78" rows="7"></textarea>
              </div>
