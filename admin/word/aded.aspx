<%@ Page Language="C#" AutoEventWireup="true" CodeFile="aded.aspx.cs" Inherits="admin_word_aded" %>
...
<body>
    ...
    <div id="main">
        <div class="box-a">
            <h5>编辑词</h5>
            <div class="pd-5">
                <table width="100%" border="0" cellspacing="0" cellpadding="0" summary="编辑词" class="t-list mt-10">
                    <tr>
                        <td width="80" height="35">词名称： </td>
